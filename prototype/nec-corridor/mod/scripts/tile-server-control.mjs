...
const HEALTH_TILE = 'NEC_CP00_RP00/2/2/2.mvt?v=nec-corridor-z0-z9-v1';
...
export async function ensureTileServerReady({
  ...
  const started = spawnSyncImpl('powershell.exe', ['-NoProfile', '-ExecutionPolicy', 'Bypass', '-File', starterPath], {
    stdio: 'inherit',
    windowsHide: true,
  });
