...
export const DEFAULT_TILE_BASE = 'http://127.0.0.1:8800';
export const BASEMAP_REVISION = 'tokyo-kanagawa-mainland-v2';
...
export function refreshPilotCityBindings(
  ...
  if (typeof api?.map?.setTileURLOverride !== 'function') throw new Error('[Tokyo–Kanagawa] map.setTileURLOverride is unavailable');
