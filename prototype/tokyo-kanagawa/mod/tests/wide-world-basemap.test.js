...
const buildScript = path.join(prototypeRoot, 'build-tokyo-kanagawa.ps1');

test('Tokyo–Kanagawa PMTiles build preserves the NEC world background at wide zooms', () => {
  ...
  assert.match(
    ...
    'the normal Tokyo–Kanagawa build must run the unified basemap stage',
  );
});
