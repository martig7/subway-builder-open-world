...
const worldRoot = path.join(repositoryRoot, 'worlds', 'tokyo-kanagawa');
const artifactsRoot = process.env.TOKYO_KANAGAWA_ARTIFACTS_ROOT
  ? path.resolve(process.env.TOKYO_KANAGAWA_ARTIFACTS_ROOT)
