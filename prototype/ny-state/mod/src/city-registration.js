...
export const DEFAULT_TILE_BASE = 'http://127.0.0.1:8798';
export const BASEMAP_REVISION = 'world-z0-z9-v2';
...
export function refreshPilotCityBindings(
  ...
  if (typeof api?.map?.setTileURLOverride !== 'function') throw new Error('[NY pilot] map.setTileURLOverride is unavailable');
